      ...
      {Object.keys(Icons).map(name => {
        ...
        return (
          <Flex alignItems="center">
            <Component fontSize={3} justifySelf="center" />
            <Text ml={2} fontSize={9} color="#666">
              {name}
            </Text>
          </Flex>
        );
...
<Preview>
  <Story name="sizing with font-size">
    <Flex alignItems="center">
      <Icons.Loader fontSize={0} mr={2} />
      <Icons.Loader fontSize={1} mr={2} />
      <Icons.Loader fontSize={2} mr={2} />
      <Icons.Loader fontSize={3} mr={2} />
      <Icons.Loader fontSize={4} mr={2} />
      <Icons.Loader fontSize={5} mr={2} />
      <Icons.Loader fontSize={6} mr={2} />
      <Icons.Loader fontSize={7} mr={2} />
    </Flex>
  </Story>
</Preview>
...
<Preview>
  <Story name="color">
    <Flex alignItems="center">
      <Icons.CheckboxChecked color="red" mr={2} />
      <Icons.CheckboxChecked color="orange" mr={2} />
      <Icons.CheckboxChecked color="gold" mr={2} />
      <Icons.CheckboxChecked color="green" mr={2} />
      <Icons.CheckboxChecked color="blue" mr={2} />
      <Icons.CheckboxChecked color="indigo" mr={2} />
      <Icons.CheckboxChecked color="violet" mr={2} />
    </Flex>
  </Story>
</Preview>
...
- Checkbox blank, checked & indeterminate
...
<Preview withSource={SourceState.OPEN}>
  <Story name="as decorative">
    <Icons.RadioChecked aria-hidden />
  </Story>
</Preview>

When used for **non-decorative** purposes, it must have a proper alternative text set via `title` and `titleId` props.

<Preview withSource={SourceState.OPEN}>
  <Story name="as non-decorative">
    <Icons.Loader
      title="waiting for content to load"
      titleId="loader-icon-story"
    />
  </Story>
</Preview>
