      ...
      {Object.keys(Icons).map(name => {
        ...
        return (
          <Flex key={name} alignItems="center">
            <Component fontSize={6} justifySelf="center" aria-hidden />
            <Text ml={2} fontSize={1} mb={0} color="#666">
              {name}
            </Text>
          </Flex>
        );
...
<Preview withSource="open">
  <Story name="usage">
    <Icons.CheckboxChecked title="checkbox checked" />
  </Story>
</Preview>
...
<Preview>
  <Story name="sizing with font-size">
    <Flex alignItems="center">
      <Icons.Loader fontSize={0} mr={2} aria-hidden />
      <Icons.Loader fontSize={1} mr={2} aria-hidden />
      <Icons.Loader fontSize={2} mr={2} aria-hidden />
      <Icons.Loader fontSize={3} mr={2} aria-hidden />
      <Icons.Loader fontSize={4} mr={2} aria-hidden />
      <Icons.Loader fontSize={5} mr={2} aria-hidden />
      <Icons.Loader fontSize={6} mr={2} aria-hidden />
      <Icons.Loader fontSize={7} mr={2} aria-hidden />
    </Flex>
  </Story>
</Preview>
...
<Preview>
  <Story name="sizing with layout props">
    <Icons.Loader width={3} height={3} aria-hidden />
  </Story>
</Preview>
