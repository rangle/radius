...
export const RenderPiece = (props: ControlState) => {
    if (props.controlsState === null) { return null; }
...
export function RenderControls<T extends Props>(props: ControlState<T> & { onChange: ComponentProps<ComponentBuilder<T>["controls"]>["onChange"] }) {
