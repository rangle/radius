...
const Editor = () => {
  ...
  return <div className={style.content}>
    <div className={style.contentButtons}>
      <DsButton onClick={() => setSelectedIndex(0)} size='small' variant={
        selectedIndex === 0 ? 'primary' : 'secondary'
      }>Colors</DsButton>
      &nbsp;&nbsp;
      <DsButton onClick={() => setSelectedIndex(2)} size='small' variant={
        selectedIndex === 1 ? 'primary' : 'secondary'
      }>Spaces</DsButton>
      &nbsp;&nbsp;
      <DsButton onClick={() => setSelectedIndex(1)} size='small' variant={
        selectedIndex === 2 ? 'primary' : 'secondary'
      }>Borders</DsButton>
      &nbsp;&nbsp;
      <DsButton onClick={() => setSelectedIndex(3)} size='small' variant={
