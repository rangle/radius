  ...
  return (
    <>
      <div className={styles.container}>
        ...
        &nbsp;&nbsp;
        <DsButton onClick={() => onThemeClick(1)} variant="secondary" size='medium'>Apply Theme One</DsButton>
        &nbsp;&nbsp;
        <DsButton onClick={() => onThemeClick(2)} variant="secondary" size='medium'>Apply Theme Two</DsButton>
      </div>
