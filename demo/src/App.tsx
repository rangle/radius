...
const App = () => {
  const onThemeClick = (index: number) => {
    ...
    utils.changeTheme(tokens);
  };

  return (
    <>
      <div className={styles.container}>
        <DsButton onClick={() => onThemeClick(0)} variant="primary" size='medium'>Reset Theme One</DsButton> 
        &nbsp;&nbsp;
        <DsButton onClick={() => onThemeClick(1)} variant="primary" size='medium'>Apply Theme One</DsButton>
        &nbsp;&nbsp;
        <DsButton onClick={() => onThemeClick(2)} variant="primary" size='medium'>Apply Theme Two</DsButton>
      </div>
